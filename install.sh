...
SKILL_NAME="playwright-qa-plus"
REPO_URL="https://github.com/jim98155225/playwright-qa-plus"
SKILLS_DIR="$HOME/.claude/skills"
DEST="$SKILLS_DIR/$SKILL_NAME"
TMP=$(mktemp -d)

echo ""
echo "🎭 playwright-qa-plus 安裝程式（強化版）"
echo "====================================="
echo ""
...
echo "  3. 輸入：/qa-plus-audit https://your-site.com"
echo ""
